        ...
        <div className="modal active" onClick={() => setRecordModalOpen(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="history-list">
              <div className="history-item" onClick={() => alert('查看 2023 稅年記錄')">
                <h4>2023 稅年</h4>
                <p>Form 8843, Form 1040-NR</p>
                <div className="date">提交日期：2023年4月15日</div>
              </div>
              <div className="history-item" onClick={() => alert('查看 2022 稅年記錄')">
                <h4>2022 稅年</h4>
                <p>Form 8843</p>
                <div className="date">提交日期：2022年4月15日</div>
              </div>
              <div className="history-item" onClick={() => alert('查看 2021 稅年記錄')">
                <h4>2021 稅年</h4>
                <p>Form 8843</p>
